		...
		{	
			...
			if($show_field == 1)
			{
				...
				else
				{
					...
					if((!is_array($value) && $value != "" && $keyfield == $value) || (is_array($value) && in_array($keyfield,$value)))
					{
						$return .= " selected";
					}
				}
