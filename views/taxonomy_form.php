...
<select id="txn-attach" name="txn-attach" multiple="multiple">
		...
		<div class="control-group row-fluid">
								<div class="controls"><label class="checkbox">Show Advanced Options
    ...
    <div id="txntabs" style="display:none;">
		...
		<div class="control-group row-fluid">
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-search_items"  id="txn-search_items" type="text" placeholder="e.g. Search Product Tags"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
					</div>
					<div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-popular_items" id="txn-popular_items" type="text" placeholder="e.g. Popular Product Tags"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
                    	</div>
                    </div>
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-all_items" id="txn-all_items" type="text" placeholder="e.g. All Product Tags"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid" id="txn-parent_item_div" style="display:none;">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-parent_item" id="txn-parent_item" type="text" placeholder="e.g. Parent Product Tag"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid" id="txn-parent_item_colon_div" style="display:none;">
						<label class="control-label span3">Parent Item:</label>
						<div class="controls span9">
						<input class="input-xlarge" name="txn-parent_item_colon" id="txn-parent_item_colon" type="text" placeholder="e.g. Parent Product Tag:"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
					<div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-edit_item" id="txn-edit_item" type="text" placeholder="e.g. Edit Product Tag"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-update_item" id="txn-update_item" type="text" placeholder="e.g. Update Product Tag"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-add_new_item" id="txn-add_new_item" type="text" placeholder="e.g. Add New Product Tag"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-new_item_name" id="txn-new_item_name" type="text" placeholder="e.g. New Product Tag Name"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
					<div class="control-group row-fluid" id="txn-separate_items_with_comas_div">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-separate_items_with_comas" id="txn-separate_items_with_comas" type="text" placeholder="e.g. Separate product tags with commas"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid" id="txn-add_or_remove_items_div">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-add_or_remove_items" id="txn-add_or_remove_items" type="text" placeholder="e.g. Add or remove product tags"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                    ...
                    <div class="control-group row-fluid" id="txn-choose_from_most_used_div">
						...
						<div class="controls span9">
						<input class="input-xlarge" name="txn-choose_from_most_used" id="txn-choose_from_most_used" type="text" placeholder="e.g. Choose from the most used product tags"> <a href="#" title="Custom taxonomy label.  Used in the admin menu for displaying taxonomies." style="cursor: help;">
						<i class="icon-info-sign"></i></a>
						</div>
                    </div>
                </div>
