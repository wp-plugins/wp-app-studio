...
function wpas_add_widget_form($app_id)
{
	?>
		...
		jQuery(document).ready(function() {
				...
				jQuery('#widg-dash_subtype,#widg-side_subtype').click(function() {
					...
					else if(jQuery(this).find('option:selected').val() == 'entity')
					{
						...
						{
							jQuery('#add-widget-div #widg-attach').html('<option value="">Please select</option>'+response);
						}); 
					}
		...
		<div class="control-group row-fluid">
                ...
                <a href="#" title='Sets the title of the widget on sidebar or dashboard. For relationship widgets, it is used as "from entity" relationship title.' style="cursor: help;">
		...
		<div class="control-group row-fluid">
                ...
                <a href="#" style="cursor: help;" title="Widgets could be created either on sidebar or dashboard.">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
		<div class="control-group row-fluid" id="widg-dash_subtype_div" style="display:none;">
                ...
                <a href="#" style="cursor: help;" title="Sets the type of dashboard widget.">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
		<div class="control-group row-fluid" id="widg-side_subtype_div" style="display:none;">
                ...
                <a href="#" style="cursor: help;" title="Sets the type of sidebar widget. ">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
		...
		</select><a href="#" title="All widgets must be attached to a predefined entity. Entity widgets display the attached entity's content." style="cursor: help;">
		<i class="icon-info-sign"></i></a>
		</div>
		</div>
		<div class="control-group row-fluid" id="widg-attach-rel_div" style="display:none;">
		<label class="control-label span3">Attach to Relationship</label>
		<div class="controls span9">
		<select id="widg-attach-rel" name="widg-attach-rel">
		</select><a href="#" title="All widgets must be attached to a predefined relationship. Relationship widgets display the attached relationship's content." style="cursor: help;">
		<i class="icon-info-sign"></i></a>
		</div>
		</div>
		<div class="control-group row-fluid" id="widg-rel-conn-type_div" style="display:none;">
                <label class="control-label span3" >Connection Type</label>
                <div class="controls span9">
		...
		<option value="">Please select</option>
                ...
                <label class="control-label span3">Widget To Title</label>
                <div class="controls span9">
                <input class="input-xlarge" name="widg-rel-to-title" id="widg-rel-to-title" type="text" placeholder="e.g. Recent Products">
                <a href="#" title="Sets the initial 'to entity' relationship title. You can change this from the widget's configuration dialog after the widget is created." style="cursor: help;">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
                ...
                <a href="#" title="Sets the initial title of the widget which will displayed on the backend." style="cursor: help;">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
                ...
                <a href="#" title="Sets the initial short description explaining what the widget does." style="cursor: help;">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
		...
		<a href="#" style="cursor: help;" title="Sets the initial message of the dashboard widget for application-wide messages.">
                <i class="icon-info-sign"></i></a>
                </div>
                </div>
...
font-style:italic;
	...
	?>
		<a href="#" style="cursor: help;" title="The widget layout defines how the content will be displayed within the widget."><i class="icon-info-sign"></i></a>
		</div>
		</div>
		...
		<a href="#" style="cursor: help;" title="The custom css code to be used when displaying the content. You can leave this field blank and use WPAS app css file.">
		<i class="icon-info-sign"></i></a>
		</div>
		</div>
		...
		<a href="#" style="cursor: help;" title="Allows the content to be sorted ascending or descending. Defaults to descending. ">
		<i class="icon-info-sign"></i></a>
		</div>
		</div>
