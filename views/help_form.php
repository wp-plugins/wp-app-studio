	...
	<div class="well">
        ...
        <fieldset>
                   <div class="control-group">
							<label class="control-label"><?php _e("Attach To","wpas"); ?></label>
							<div class="controls">
...
<a href="#" title="<?php _e("Select the entity or taxonomy you want to display helpscreen at.","wpas"); ?>" style="cursor: help;"><i class="icon-info-sign"></i></a></div>
							</div>
...
<a href="#" title="<?php _e("Select the location of the helpscreen. You can select list or edit page.","wpas"); ?>" style="cursor: help;"><i class="icon-info-sign"></i></a></div>
							</div>
                   <div class="control-group">
...
?>
<a href="#" title="<?php _e("The content of the helpsceen sidebar.","wpas"); ?>" style="cursor: help;"><i class="icon-info-sign"></i></a></div>
							</div>
				</div>                                                                                      
	<div class="control-group">
