...
function wpas_add_shortcode_form($app_id)
{
	?>
		...
		<fieldset>
		<div class="well">
		<div class="row-fluid"><div class="alert alert-info pull-right"><a class="icon-info-sign" data-placement="bottom" href="#" rel="tooltip" title="A shortcode is a type of macro which allows publishing dynamic content without the need for programming skills."> HELP</a></div></div>
		...
		</select><a href="#" title="Entity shortcodes must be attached to already defined entity. The attached entity's content are returned by the shortcode." style="cursor: help;">
		<i class="icon-info-sign"></i></a>
		</div>
		</div>
		<div class="control-group row-fluid">
...
?>
		<a href="#" style="cursor: help;" title="The layout of the entity's content using its shortcode. It defines how the content will be displayed using the shortcode."><i class="icon-info-sign"></i></a>
		</div>
		</div>
		<div class="control-group row-fluid">
